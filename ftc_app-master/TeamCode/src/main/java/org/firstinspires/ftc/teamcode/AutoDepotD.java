...
@Autonomous(name="Depot D", group="Autonomous")
public class AutoDepotD extends LinearOpMode {
    ...
    public void runOpMode() /* Run auto code */
    {
        ...
        if(opModeIsActive()) {
            ...
            motorEncoderRunner.AddMovements(hw.straightMovementInches(6.5, 1));
            motorEncoderRunner.StartMovements(30);
            motorEncoderRunner.Clear();

            if (goldPos == "LEFT") {
                motorEncoderRunner.AddMovements(hw.turnDegrees(49, true, 1)); // 121 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.straightMovementInches(-24, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.turnDegrees(10, true, 1)); // 121 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.straightMovementInches(-16, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.turnDegrees(86, true, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();
                ...
                motorEncoderRunner.AddMovements(hw.straightMovementInches(15, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                hw.totemServo.setPosition(hw.UP_TOTEM_POSITION);

                motorEncoderRunner.AddMovements(hw.straightMovementInches(47, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovement(hw.motorMovementRevolutions(hw.mineralArmDrive, 1, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

            } else if (goldPos == "MIDDLE") {
                motorEncoderRunner.AddMovements(hw.turnDegrees(90, false, 1)); // 90 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.straightMovementInches(48, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.turnDegrees(127, true, 1)); // 90 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.straightMovementInches(4, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                hw.totemServo.setPosition(hw.DOWN_TOTEM_POSITION);

                motorEncoderRunner.AddMovements(hw.straightMovementInches(27, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.turnDegrees(6, true, 1)); // 90 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.straightMovementInches(30, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();
                ...
                // Gold pos == RIGHT
                motorEncoderRunner.AddMovements(hw.turnDegrees(127, true, 1)); // 53 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.straightMovementInches(-40, 1));
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();

                motorEncoderRunner.AddMovements(hw.turnDegrees(75, false, 1)); // 53 + 180 cc
                motorEncoderRunner.StartMovements(30);
                motorEncoderRunner.Clear();
