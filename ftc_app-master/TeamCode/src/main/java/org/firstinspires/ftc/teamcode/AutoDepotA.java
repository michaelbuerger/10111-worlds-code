...
public class AutoDepotA extends LinearOpMode {
    ...
    public void runOpMode() /* Run auto code */
    {
        ...
        if(goldPos == "LEFT")
        {
            motorEncoderRunner.AddMovements(hw.turnDegrees(54, true, 1)); // 121 + 180 cc
            motorEncoderRunner.StartMovements(30);
            motorEncoderRunner.Clear();
        ...
        } else if(goldPos == "MIDDLE")
        {
            ...
            motorEncoderRunner.AddMovements(hw.straightMovementInches(51, 1));
            motorEncoderRunner.StartMovements(30);
            motorEncoderRunner.Clear();
            ...
            motorEncoderRunner.AddMovements(hw.straightMovementInches(57, 1));
            motorEncoderRunner.StartMovements(30);
            motorEncoderRunner.Clear();
